...
_See code: [dist/commands/endpoint/invoke.ts](https://github.com/klayrhq/klayr-core/blob/v4.1.4/dist/commands/endpoint/invoke.ts)_
...
_See code: [dist/commands/endpoint/list.ts](https://github.com/klayrhq/klayr-core/blob/v4.1.4/dist/commands/endpoint/list.ts)_
