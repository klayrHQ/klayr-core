...
Please ensure, that the xref:ROOT::understand-blockchain/mainchain.adoc[necessary ports] are open to run Klayr Core as intended.
...
NOTE: `8778` and `7887` are the default ports.
