...
[IMPORTANT]
====
You most likely already have a `keys.json` file from the Lisk Core v4 node. If you have already have the keys file, you need to update the address in the `keys.json` file to the new address of the validator.
