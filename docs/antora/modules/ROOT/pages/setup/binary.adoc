...
:description: How to install and set up a Klayr Core (binary distribution).
:toc: preamble
:toclevels: 5
:sectnums:
:page-toclevels: 4
...
// Project URLs
:url_run_logging: klayr-docs::run-blockchain/logging.adoc
...
:klayr_core_latest_version: 4.1.1
...
----
curl -o klayr-core.tar.gz https://downloads.klayr.com/klayr/mainnet/{klayr_core_latest_version}/klayr-core-v{klayr_core_latest_version}-linux-x64.tar.gz
----
...
[source,bash,subs="attributes"]
----
curl -o klayr-core.tar.gz https://downloads.klayr.com/klayr/mainnet/{klayr_core_latest_version}/klayr-core-v{klayr_core_latest_version}-darwin-x64.tar.gz
----
--
////
...
[source,bash,subs="attributes"]
----
curl -o klayr-core.tar.gz https://downloads.klayr.com/klayr/testnet/{klayr_core_latest_version}/klayr-core-v{klayr_core_latest_version}-linux-x64.tar.gz
----
...
[source,bash,subs="attributes"]
----
curl -o klayr-core.tar.gz https://downloads.klayr.com/klayr/testnet/{klayr_core_latest_version}/klayr-core-v{klayr_core_latest_version}-darwin-x64.tar.gz
----
--
====
...
To make `klayr-core` permanently available in the CLI, add the above snippet to `~/.zshrc`.
...
[source,bash]
----
klayr-core start --network mainnet --log=info
----
