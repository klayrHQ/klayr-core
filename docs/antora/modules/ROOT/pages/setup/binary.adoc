...
:klayr_core_latest_version: 4.1.3
...
----
curl -o klayr-core.tar.gz https://downloads.klayr.xyz/klayr/mainnet/{klayr_core_latest_version}/klayr-core-v{klayr_core_latest_version}-linux-x64.tar.gz
----
...
[source,bash,subs="attributes"]
----
curl -o klayr-core.tar.gz https://downloads.klayr.xyz/klayr/mainnet/{klayr_core_latest_version}/klayr-core-v{klayr_core_latest_version}-darwin-x64.tar.gz
----
--
////
...
[source,bash,subs="attributes"]
----
curl -o klayr-core.tar.gz https://downloads.klayr.xyz/klayr/testnet/{klayr_core_latest_version}/klayr-core-v{klayr_core_latest_version}-linux-x64.tar.gz
----
...
[source,bash,subs="attributes"]
----
curl -o klayr-core.tar.gz https://downloads.klayr.xyz/klayr/testnet/{klayr_core_latest_version}/klayr-core-v{klayr_core_latest_version}-darwin-x64.tar.gz
----
--
====
